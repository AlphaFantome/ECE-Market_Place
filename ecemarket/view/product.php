...
if ($product == null) {
    ...
    echo "<script>alert('Product does not exist anymore.')</script>";
...
<div class="container my-5">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <img src="data:image;base64,<?= base64_encode($product->get_thumbnail()) ?>" class="img-fluid"
                 alt="product image">
        </div> <!-- Product Image Ends -->

        <!-- Product Details Starts -->
        <div class="col-md-4">
            <h8><strong>Vendeur :</strong>
                <em><?= $account_controller->get_account_name($product->get_seller_account_id()) ?></em></h8>
            ...
            <p>
                ...
                <?php endfor; ?>
                &nbsp; <?= $feedback_informations->get_count_reviews() ?> Commentaire(s)
            </p>

            <div class="dropdown-divider mt-3"></div>
            <p class="mb-0">
                <span class="text-muted mr-2">Prix :</span>
                <span class="text-danger font-weight-bold"><?= $product->get_price() ?> &nbsp;<i
                ...
                <?php if ($product->is_auction() || $product->is_best_offer()) : ?>
                    ...
                    <?php if ($product->is_auction()) : ?>
                        <span class="text-muted mr-2">Fin de l'enchère :</span>
                        <span class="text-danger font-weight-bold"><?= $product->get_end_of_auction() ?> &nbsp;<i
            ...
            <div class="row" style="font-size: 12px; font-weight: bold;">
                    ...
                    <form method="POST">
                        <?php if ($product->is_auction() || $product->is_best_offer()) : ?>
                            ...
                            <div class="form-outline">
                                <input type="number" id="typeNumber" class="form-control" name="auction_proposal"
                                       min="<?= $product->get_price() + 1 ?>" required>
                                <label class="form-label" for="typeNumber">proposer prix</label>
                            </div>

                        <?php endif; ?>
                        <button class="btn btn-warning btn-sm  mt-3" type="submit" name="add_to_cart_btn">
                            <i class="fas fa-cart-plus float-left text-primary"
                               style="font-size: 25px; width:80px;"></i>
                            <?= $product->get_type_of_sale() == 0 || ($product->get_type_of_sale()) == 1 ? 'Faire une offre' : 'Ajouter au panier'; ?>
                ...
                <a href="#">
                    ...
                    Selectionner un service de livraison
                </a>
        ...
        <div class="row border-bottom mt-3">
            <div class="col-md-12 my-3">
                <h6 class="text-warning font-weight-bold">Description</h6>
        ...
        <div class="row my-5">
            <div class="col-md-4">
                <p class=" font-weight-bold">Noter le produit</p>
                <a class="btn btn-sm bg-transparent"
                   href="<?= !isset($_SESSION['account']) ? Navigation::sign_in_page() : Navigation::product_feedback_page(5, $product->get_id(), $product->get_seller_account_id()) ?>">
                ...
                <br>
                <a class="btn btn-sm bg-transparent"
                   href="<?= !isset($_SESSION['account']) ? Navigation::sign_in_page() : Navigation::product_feedback_page(4, $product->get_id(), $product->get_seller_account_id()) ?>">
                    <i class="fas fa-star" style="color: #ffa41c;"></i>
                    <i class="fas fa-star" style="color: #ffa41c;"></i>
                    <i class="fas fa-star" style="color: #ffa41c;"></i>
                    <i class="fas fa-star" style="color: #ffa41c;"></i>
                ...
                <br/>
                <a class="btn btn-sm bg-transparent"
                   href="<?= !isset($_SESSION['account']) ? Navigation::sign_in_page() : Navigation::product_feedback_page(3, $product->get_id(), $product->get_seller_account_id()) ?>">
                    <i class="fas fa-star" style="color: #ffa41c;"></i>
                    <i class="fas fa-star" style="color: #ffa41c;"></i>
                    <i class="fas fa-star" style="color: #ffa41c;"></i>
                    <i class="far fa-star" style="color: #ffa41c;"></i>
                ...
                <br/>
                <a class="btn btn-sm bg-transparent"
                   href="<?= !isset($_SESSION['account']) ? Navigation::sign_in_page() : Navigation::product_feedback_page(2, $product->get_id(), $product->get_seller_account_id()) ?>">
                    <i class="fas fa-star" style="color: #ffa41c;"></i>
                    <i class="fas fa-star" style="color: #ffa41c;"></i>
                    <i class="far fa-star" style="color: #ffa41c;"></i>
                    <i class="far fa-star" style="color: #ffa41c;"></i>
                ...
                <br/>
                <a class="btn btn-sm bg-transparent"
                   href="<?= !isset($_SESSION['account']) ? Navigation::sign_in_page() : Navigation::product_feedback_page(1, $product->get_id(), $product->get_seller_account_id()) ?>">
                    <i class="fas fa-star" style="color: #ffa41c;"></i>
                    <i class="far fa-star" style="color: #ffa41c;"></i>
                    <i class="far fa-star" style="color: #ffa41c;"></i>
                    <i class="far fa-star" style="color: #ffa41c;"></i>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <span class="text-dark"
                                  style="text-decoration: none;"> <?= $account_controller->get_account_name($fdb['author_account_id']) ?></span>
