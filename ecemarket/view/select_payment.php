...
<div class="container my-5">
    ...
    <p class="my-0 py-0">Obtenez un remboursement instantané sur les annulations | Aucun échec de paiement</p>
        ...
        <div class="col-md-8">
            ...
            <div class="card p-2">
                <form method="POST" action="<?= Navigation::review_order_page() ?>">
                    ...
                    <div class="row mb-4">
                        <div class="col">
                            <div class="form-outline">
                                ...
                                <label class="form-label" for="form3Example1">Nom sur la carte</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-outline">
                                <input type="text" id="form3Example2" class="form-control" required/>
                                <label class="form-label" for="form3Example2">Numéro de carte</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Submit button -->
                    <button type="submit" class="btn btn-warning btn-block btn-sm">Continuer</button>
                </form>
            </div>
