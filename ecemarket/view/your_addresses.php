...
<div class="container mt-5 mb-5">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent ml-n3">
            ...
            <li class="breadcrumb-item active text-danger" aria-current="page">Vos Adresses</li>
        </ol>
    </nav> <!-- URL Breadcrumb Ends -->

    <h3>Vos Adresses</h3> <br>
            ...
            <div class="col-md-4 my-md-0 my-2">
                <div class="card">
                    <div class="card-header bg-transparent">
                        <p class="text-muted p-0 m-0">Adresse : <i class="fas fa-home"></i></p>
                    </div>
                    ...
                    <div class="card-footer bg-transparent">
                        ...
                        <a href="<?= Navigation::delete_address_handler($_SESSION['account']['id'], $addr['postal_code'], $addr['address'], $addr['owner_name']) ?>"
