...
<div class="container mt-5 mb-5">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent ml-n3">
            ...
            <li class="breadcrumb-item active text-danger" aria-current="page">Vos commandes</li>
        </ol>
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-4 mt-3 mt-md-0">
                        <p class="text-uppercase text-muted my-0">commande passée</p>
                    ...
                    <div class="col-md-4 mt-3 mt-md-0">
                        <p class="text-uppercase text-muted my-0 float-md-right">order
                            # <?= $purchase_order['guid'] ?></p>
                    </div>
                </div>
            </div>
                ...
                foreach ($purchased_products as $key => $purchased_product) : ?>
                    <div class="row">
                        <div class="col-md-1">
                            ...
                            <img src="data:image;base64,<?= base64_encode($purchased_product['product_thumbnail']) ?>"
                                 width="105" height="130" alt="product 01 image">
                        </div>

                        <div class="col-md-5">
                            <a href="#"><?= $purchased_product['product_name'] ?></a>
                            <p class="text-muted my-0">Vendeur
                                : <?= $account_controller->get_account_name($purchased_product['seller_account_id']) ?></p>
                            <p class="text-muted my-0">Prix unitaire
                                : <?= $purchased_product['product_price'] / $purchased_product['product_quantity'] ?> <i
                                        class="fas fa-dollar-sign"></i></p>
                            <p class="text-muted my-0">Quantité : <?= $purchased_product['product_quantity'] ?></p>
                            <p class="text-uppercase my-0">
                                <span class="text-danger"><?= $purchased_product['product_price'] ?></span> <i
                            ...
                            <div class="col-md-6 d-flex flex-column">
                                <form method="POST">
                                    <button type="submit" name="delete_purchase_order"
                                            class="btn btn-outline-secondary btn-sm w-50 ml-auto my-1">Supprimer le bon de  commande
                                    </button>
                                    <button type="submit" name="generate_invoice"
                                            class="btn btn-outline-info btn-sm w-50 ml-auto my-1">Générer la facture
                                    </button>
                                    <input type="text" value="<?= $purchase_order['guid'] ?>" name="purchase_order_guid"
                                           hidden>
                                    <input type="text" value="<?= $purchase_order['date'] ?>" name="purchase_order_date"
                                           hidden>
