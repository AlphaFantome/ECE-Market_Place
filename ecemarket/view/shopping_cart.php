                            ...
                            <div class="number-input md-number-input">
                                <form method="POST">
                                    ...
                                    <button onclick="this.parentNode.querySelector('input[type=number]').stepDown()"
                                            class="btn btn-info btn-sm" type="submit" name="decrement_quantity_btn">-
                                    </button>
                                    <input class="text" min="1" name="quantity" value="<?= $product->get_quantity() ?>"
                                           type="number" disabled>
                                    <button onclick="this.parentNode.querySelector('input[type=number]').stepUp()"
                                            class="btn btn-info btn-sm" type="submit" name="increment_quantity_btn">+
                                    </button>
                                </form>
                            </div>
                        </div>
            ...
            <div class="row border-top py-3">
                <div class="col-md-12 ">
                    <p class="float-right font-weight-bold">
                        Subtotal (<?= $total_item ?> items) : <span><?= $total_price ?></span> <i
                                class="fas fa-dollar-sign" style="font-size: 10px;"></i>
                    </p>
                </div>
            </div>
        ...
        <div class="col-md-4 text-center pl-md-5 pl-0">
            ...
            <div class="card my-3">
                ...
                <div class="card-body text-center" style="background-color: #f3f3f3;">
                    ...
                    <?php if ($total_item > 0) : ?>
                        <a href="<?= Navigation::select_address_page() ?>" class="btn btn-warning btn-sm btn-block">
